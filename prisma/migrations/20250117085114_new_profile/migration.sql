...
-- AddForeignKey
ALTER TABLE `Book` ADD CONSTRAINT `Book_profileId_fkey` FOREIGN KEY (`profileId`) REFERENCES `Profile`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Order` ADD CONSTRAINT `Order_orderedUserId_fkey` FOREIGN KEY (`orderedUserId`) REFERENCES `Profile`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
